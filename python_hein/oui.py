...
# game objects
ball = my_pygame.Rectangle(screen_width/2 - ballw/2, screen_height/2 - ballh/2, ballw, ballh)
#ball = my_pygame.Rectangle(30,30, ballw, ballh)
ball.maxspeedx = ball_speed_x
ball.maxspeedy = ball_speed_y

player_l = my_pygame.Rectangle( 0 + 10, (screen_height/2 - pl_sizey/2), pl_sizex, pl_sizey)
player_l.maxspeedy = pl_speed_y

player_r = my_pygame.Rectangle((screen_width - pr_sizex) - 10, (screen_height/2 - pr_sizey/2), pr_sizex, pr_sizey)
